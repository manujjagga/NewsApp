package com.example.news.util.remoteUtils

import com.example.news.util.remoteUtils.Status.SUCCESS
import com.example.news.util.remoteUtils.Status.ERROR
import com.example.news.util.remoteUtils.Status.LOADING
